...
public class UseButtonAndLED {
    ...
    public static void main(String[] args) throws Exception{
        ...
        while(true){
            ...
            //if either button is pressed add 1 each time to bCount
            if (redButton.getState() || greenButton.getState()) {
             
				bCount++;
               
            	System.out.println("Button count: " + bCount);
            }
            //made it quicker because 150 was a little too slow
            Thread.sleep(120);
        }
    }
 }
